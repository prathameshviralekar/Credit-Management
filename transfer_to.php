...
<body>
	...
	<center>
		<div class="view">
			<br><br><h2 style=" font-size:45px;color:#e0115f;text-shadow: 2px 2px black;">Transfer Credits</h2>
		...
		<tr>
			<td>
			<br><label for="transfer">Credits:</label> 
			&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<input type="number" name="transfer" style="font-size: 12pt; height: 28px; width:290px;"></td>
		</tr>
       <tr>
			<td>
				<div class="button">
	...
	<form action="user.php" method="post">
			<div class="buttons">
				<button class="btn-hover color-1" type="submit" name="name" value="<?php echo $name1 ?>">BACK</button>
			</div>
	</form>
</center>
</body>
